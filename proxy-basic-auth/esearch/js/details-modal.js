...
function initializeModalApi() {
  ...
  function getEditSetter(domId) {
    let editSetter;
    const node = document.getElementById(domId);
    if (node) {
      editSetter = (url) => node.href = url;
    } else {
      editSetter = () => { console.log('bothing!') };
    }
    return editSetter;
  }

  const detailsModalApi = {
    ...
    setReferentEditUrl: getEditSetter('referent-edit-link'),
    setRecordEditUrl: getEditSetter('record-edit-link'),
    setSourceEditUrl: getEditSetter('source-edit-link') /*
